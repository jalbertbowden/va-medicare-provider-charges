...
if ($(window).width() < 626) {
	var map = new L.Map('map').setView([37.431573,-78.656894],6);
} else {
	var map = new L.Map('map').setView([37.431573,-78.656894],14);
}
// 37.431573 , -78.656894
...
jqueryNoConflict(document).ready(function(){
	initializeTabletopObject('0Aq0hZevysGfkdFJfd2JrX1pMV28zV1NOTVRIMlNLeWc');
});
