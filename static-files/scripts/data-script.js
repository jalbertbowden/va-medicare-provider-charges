...
var defaultTableOptions = {
    ...
    spreadsheetKey: '0Aq0hZevysGfkdFJfd2JrX1pMV28zV1NOTVRIMlNLeWc',
    ...
    dataHeaders: ['drg definition', 'provider id', 'provider name', 'provider street address', 'provider city', 'provider state', 'provider zip code', 'hospital referral region description', 'total discharges', 'average covered charges', 'average total payments'],

    // proper display names as you want them to appear in the table
    columnHeaders: ['DRG Definition', 'Provider Id', 'Provider Name', 'Provider Street Address', 'Provider City', 'Provider State', 'Provider Zip Code', 'Hospital Referral Region Description', 'Total Discharges', 'Average Covered Charges', 'Average Total Payments'],
